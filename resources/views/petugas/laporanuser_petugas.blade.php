...
<head>
    ...
    <title>Laporan User - Petugas</title>
            ...
            <div class="header-section">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-[#7a5c45] text-sm">Laporan data user perpustakaan per tanggal {{ date('d M Y') }}</p>
                    </div>
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('petugas.laporan.user_pdf') }}"
