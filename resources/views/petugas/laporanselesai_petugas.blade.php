...
<head>
    ...
    <title>Laporan Pengembalian Selesai - Petugas</title>
        ...
        <main class="flex-1 bg-[#faf6ee]/80 rounded-3xl p-8 shadow-xl max-w-[1400px] mx-auto">
            ...
            <div class="header-section">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="judul text-4xl font-bold mb-1">Laporan Pengembalian Selesai</h2>
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('petugas.laporan.selesai_pdf') }}"
                ...
                <div class="stats-card bg-gradient-to-r from-[#e2d3c1] to-[#d4c4a8] rounded-xl p-6 mb-6 border border-[#c9a44c]/20">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-2xl font-bold">Pengembalian Selesai</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach($items as $index => $item)
                                <tr class="border-b hover:bg-[#faf6ee]/60 transition-colors duration-200">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        @php $kondisi = strtolower($item->kondisi_buku ?? 'baik'); @endphp
