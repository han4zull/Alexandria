        ...
        <main class="flex-1 bg-[#faf6ee]/80 rounded-3xl p-8 shadow-xl max-w-[1400px] mx-auto">
            ...
            <div class="header-section">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="judul text-4xl font-bold mb-1">Laporan Petugas</h2>
                        <p class="text-[#7a5c45] text-sm">Laporan data petugas per tanggal {{ date('d M Y') }}</p>
                    </div>
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('admin.laporan.petugas_pdf') }}"
            ...
            @if($items->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div class="empty-state">
                        ...
                        <p class="empty-state-subtext">Tidak ada data petugas</p>
                    </div>
                </div>
            @else
                        ...
                        <tbody class="divide-y divide-gray-200">
                            @foreach($items as $index => $item)
                                <tr class="border-b hover:bg-[#faf6ee]/60 transition-colors duration-200">
                                    ...
                                    <td class="px-4 py-3 text-sm text-[#555]">{{ $item->nama ?? '-' }}</td>
