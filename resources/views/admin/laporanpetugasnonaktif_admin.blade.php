...
@section('title', 'Laporan Petugas Nonaktif - Admin')
  ...
  <div class="max-w-7xl mx-auto mb-8">
    <div class="bg-white rounded-3xl shadow-2xl p-8 border border-[#e2d3c1]">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-[#3e2a1f] mb-2">Laporan Petugas Nonaktif</h1>
          <p class="text-[#6b5a4a]">Daftar petugas dengan status nonaktif</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-[#e2d3c1]">
      <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex gap-3">
          <a href="{{ route('admin.laporan.petugas_nonaktif_pdf') }}"
            ...
            <tr>
              <td colspan="6" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center">
                  ...
                  <p class="text-[#6b5a4a] font-medium">Tidak ada data petugas nonaktif</p>
                  <p class="text-[#9c8b7a] text-sm mt-1">Belum ada petugas yang terdaftar dengan status nonaktif</p>
                </div>
              </td>
            </tr>
            @endforelse
