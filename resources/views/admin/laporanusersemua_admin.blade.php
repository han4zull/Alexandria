...
@section('title', 'Laporan Semua User - Admin')
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-[#e2d3c1]">
      <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex gap-3">
          <a href="{{ route('admin.laporan.user_semua_pdf') }}"
            ...
            <tr>
              <td colspan="6" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center">
                  ...
                  <p class="text-[#6b5a4a] font-medium">Tidak ada data user</p>
                  <p class="text-[#9c8b7a] text-sm mt-1">Belum ada user yang terdaftar</p>
                </div>
              </td>
            </tr>
            @endforelse
