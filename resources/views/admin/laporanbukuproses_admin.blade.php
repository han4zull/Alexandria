...
<head>
    ...
    <title>Laporan Buku Proses - Admin</title>
        ...
        <main class="flex-1 bg-[#faf6ee]/80 rounded-3xl p-8 shadow-xl max-w-[1400px] mx-auto">
            ...
            <div class="header-section">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="judul text-4xl font-bold mb-1">Laporan Buku Proses</h2>
                        <p class="text-[#7a5c45] text-sm">Laporan buku dengan status menunggu persetujuan per tanggal {{ date('d M Y') }}</p>
                    </div>
                ...
                <div class="stats-card bg-gradient-to-r from-[#e2d3c1]/30 to-[#7a5c45]/20 rounded-xl p-6 mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm opacity-80 mb-1 font-medium">Total Buku Proses</p>
            ...
            @if($buku->isEmpty())
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div class="empty-state">
                        ...
                        <p class="empty-state-subtext">Tidak ada buku dengan status menunggu persetujuan</p>
                    </div>
                </div>
            @else
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="border-b hover:bg-[#faf6ee] transition">
                                ...
                                <td class="px-4 py-3 text-sm font-medium text-[#3e2a1f]">{{ $item->isbn ?? '-' }}</td>
                                <td class="px-4 py-3 text-sm font-medium text-[#3e2a1f]">{{ $item->judul }}</td>
                                <td class="px-4 py-3">
