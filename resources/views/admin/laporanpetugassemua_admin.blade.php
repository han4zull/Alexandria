...
@section('title', 'Laporan Semua Petugas - Admin')
  ...
  <div class="max-w-7xl mx-auto mb-8">
    <div class="bg-white rounded-3xl shadow-2xl p-8 border border-[#e2d3c1]">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold text-[#3e2a1f] mb-2">Laporan Semua Petugas</h1>
          <p class="text-[#6b5a4a]">Daftar semua data petugas</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-[#e2d3c1]">
      <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex gap-3">
          <a href="{{ route('admin.laporan.petugas_semua_pdf') }}"
             class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium shadow-lg hover:scale-[1.02] transition">
            ...
            <tr>
              <td colspan="6" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center">
                  ...
                  <p class="text-[#6b5a4a] font-medium">Tidak ada data petugas</p>
                  <p class="text-[#9c8b7a] text-sm mt-1">Belum ada petugas yang terdaftar</p>
                </div>
              </td>
            </tr>
            @endforelse
