      ...
      <div class="card">
        <div class="flex flex-col items-center relative">
          ...
          <div class="mt-4 text-center">
            <div class="text-2xl font-bold">{{ $admin->nama }}</div>
            <div class="text-sm text-[#7a5c45] mt-1">{{ $admin->email }}</div>
          </div>
          ...
          <div class="text-xs text-[#7a5c45]">
            “Admin yang menjaga semua sistem tetap rapi.”
          </div>
        </div>
      </div>
      ...
      <div class="card lg:col-span-2">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            ...
            <div class="value">{{ \Carbon\Carbon::parse($admin->tanggal_dibuat)->format('d M Y') }}</div>
          </div>

          <div class="space-y-2">
            <div class="label">Jenis Kelamin</div>
            <div class="value">{{ $admin->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</div>
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="value font-mono">{{ $admin->password_plain }}</div>
          </div>
        ...
        <div class="mt-6 flex gap-3">
          ...
          <a href="{{ route('profile_admin.edit') }}"
