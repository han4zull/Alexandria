...
<body>
  <div class="card">
    ...
    <h1>Bergabung dengan<br>Alexandria</h1>
    <p class="subtitle">Mulai perjalanan ilmu pengetahuan Anda</p>

    <form method="POST"
     action="{{ route('akun.register') }}">
      @csrf
      ...
      <div class="input-group">
        ...
        <span class="toggle-password" onclick="togglePassword()">
          <svg id="eyeIcon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c5a85c" stroke-width="2">
    ...
    <div class="footer">
      Sudah punya akun?
      <a href="{{ route('akun.masuk') }}">Masuk ke Alexandria</a>
    </div>
